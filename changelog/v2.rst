...
.. list-table::
    ...
    * - Type
      - Description
    * - Bugfix
      - Fixed stacked license plans returning the expire date of an already expired plan instead of the active plan.
...
.. list-table::
    ...
    * - Bugfix
      - Resolved logging issues with client IP addresses in the Security Center Backend.
...
.. list-table::
    ...
    * - Feature
      - Support Nextron Universal Installer
